...
#Generator for the Assemblt Dataset
class AssemblyGenerator(Generator):
    """
    Generator for the Assembly dataset

    """
    def __init__(self,
                 dataset_base_path,
                 object_ids = {"screw": 1, "workpiece": 2}, #dictionary with the names and object ids of the occlusion dataset
                 image_extension = ".png",
                 shuffle_dataset = True,
                  symmetric_objects = {"screw", 1}, #set with names and indices of symmetric objects
                 **kwargs):
        """
        Initializes a generator for the Assembly dataset, based on EfficientPose's occlusion generator
        Args:
            dataset_base_path: path to the ScrewDataset dataset (Assembly is a subset of ScrewDataset)
            object_ids: Dictionary mapping the Assembly object names to their object id's
        ...
        self.class_to_name = {0: "screw", 1: "workpiece"}
        ...
        self.name_to_mask_value = {"screw": 255,
                                   "workpiece": 150}
        ...
        self.image_paths, self.mask_paths, self.annotations, self.infos = self.prepare_dataset(self.object_path, self.data_examples, self.gt_dict, self.info_dict, self.class_to_valid_examples)
