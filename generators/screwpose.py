...
class ScrewPoseGenerator(Generator):
    """
    Generator for the ScrewPose dataset

    """
    def __init__(self,
                 dataset_base_path,
                 object_ids = {"M8x50": 1, "M8x25": 2, "M8x16": 3, "M6x30": 4}, #dictionary with the names and object ids of the occlusion dataset
                 image_extension = ".png",
                 shuffle_dataset = True,
                 symmetric_objects = {"M8x50", 1, "M8x25", 2, "M8x16", 3, "M6x30", 4}, #set with names and indices of symmetric objects
                 **kwargs):
        """
        ...
        self.class_to_name = {0 : "M8x50", 1 : "M8x25", 2 : "M8x16", 3 : "M6x30"}
        ...
        self.name_to_mask_value = {"M8x50": 180, "M8x25": 120, "M8x16": 255, "M6x30": 60}
...
if __name__ == "__main__":
    ...
    train_gen = ScrewPoseGenerator("/datasets/ScrewPose/", use_6DoF_augmentation = True, use_colorspace_augmentation = True)
