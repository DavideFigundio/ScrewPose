...
\begin{figure}[htp]
    \subfloat[ButtonPose]{
        \includegraphics[width=1.1\textwidth]{precision-recall.png}
    }

    \subfloat[ButtonPose-near]{
        \includegraphics[width=1.1\textwidth]{precision-recall_near.png}
    }
...
Overall our method shows promise, with precision-recall curves that are similar to the ideal, and high F1 scores.
